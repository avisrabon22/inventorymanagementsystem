...
export const UserShipping = () => {
    return (
        ...
        <div className="mt-4">
            <p>Customer login? <Link to="/" className="text-red-500">Click here</Link></p>
        </div>
        </div>
    );
    }